...
for (var i = 0; i < sums.length; i++) {
  ...
  Export.table.toDrive({
    collection: sums[i],
    description:'iraq-urban-'+years[i],
    fileFormat: 'CSV'
  });
}

// https://code.earthengine.google.com/8783a0694f5b5899a303c79bebaa8ae4