...
// ====================================================================
var mergedFC = ag.merge(other);
//print(mergedFC, 'mergedFC')
Export.table.toDrive({
  collection: mergedFC,
  description:'jordan-ag-binary',
  fileFormat: 'KML'
});
...
for (var i = 0; i < sums.length; i++) {
  ...
  Export.table.toDrive({
    collection: sums[i],
    description:'jordan-ag-'+years[i],
    fileFormat: 'CSV'
  });
}

// https://code.earthengine.google.com/77ad9d1d80a61c88d71896996749b96e