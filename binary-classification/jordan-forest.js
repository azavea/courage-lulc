...
Export.table.toDrive({
  collection: mergedFC,
  description:'jordan-forest-binary',
  fileFormat: 'KML'
});
...
Export.image.toDrive({
  ...
  description: "jordan-forest-"+2019,
  region: jordanBounds,
  scale: 30,
  maxPixels: 1e13
});
...
for (var i = 0; i < sums.length; i++) {
  ...
  Export.table.toDrive({
    collection: sums[i],
    description:'jordan-forest-'+years[i],
    fileFormat: 'CSV'
  });
}

// https://code.earthengine.google.com/0d66edccadc895c4efb43afc5c432520