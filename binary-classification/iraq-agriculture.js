...
for (var i = 0; i < sums.length; i++) {
  ...
  Export.table.toDrive({
    collection: sums[i],
    description:'iraq-ag-'+years[i],
    fileFormat: 'CSV'
  });
}

// https://code.earthengine.google.com/ebcefd19ebbf11f24cd487137d1eba15