...
'''
Randomly search through the parameter space to evaluate stochastic gradient descent
...
if __name__ == "__main__":
    ...
    random_grid = {'n_estimators': n_estimators,
                ...
                'bootstrap': bootstrap,
                'class_weight': ['balanced', weight_dict],
                'n_jobs': [args.n_jobs]
                }
    print(random_grid)
    ...
    rf_random = RandomizedSearchCV(scoring = 'f1_macro', estimator = rf, param_distributions = random_grid, n_iter = args.n_iter, cv = 3, verbose=10, random_state=42, n_jobs=1)
